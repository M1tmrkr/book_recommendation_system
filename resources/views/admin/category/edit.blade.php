                    ...
                    <form action="{{ route($_base_route.'.update', $data['rows']->id )}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" value="@if(isset($data['rows']->title)) {{ $data['rows']->title   }} @endif" name="title" placeholder="Enter Title">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Description</label>
                                <textarea name="description" class="form form-control" id="" cols="10" rows="3" placeholder="Enter Description">{{ $data['rows']->description   }}</textarea>
                            </div>
                            <div class="form-group">
