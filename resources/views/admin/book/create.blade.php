                    ...
                    <form action="{{ route($_base_route.'.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form form-control " id="summernote" cols="10" rows="6" placeholder="Enter Description">{{old('description')}}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Published Date</label>
                                <input type="date" class="form-control" id="published_date" value="{{old('published_date')}}" name="published_date" placeholder="Enter Published Date">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Publisher</label>
                                <input type="text" class="form-control" id="title" value="{{old('publisher')}}" name="publisher" placeholder="Enter Publisher">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Author</label>
                                <input type="text" class="form-control" id="title" value="{{old('author')}}" name="author" placeholder="Enter Author">
                            </div>
                            <div class="form-group">
                            ...
                            <div class=" form-group">
                                        ...
                                        <input type="file" class="form-control" id="title" name="file" placeholder="Enter file" accept=".xlsx,.xls,.doc, .docx,.ppt, .pptx,.txt,.pdf">
                            </div>
                            <div class="form-group">
